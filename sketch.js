...
function draw() {
  ...
  if (circleVisible) {
    ...
    fill(300);
    textSize(12);
    text("Éste portafolio tiene el objetivo de almacenar todos los experimentos con timbre, ramificación de", 0, -height / 2 + 45);
    text("objetos, recursión, entre otros, realizados por mí durante el curso de Imagen Escrita, en el cual", 0, -height / 2 + 65);
    text("se utilizaron herramientas como HTML, CSS, P5js, Visual Studio Code y Github. Éste fue mi primer", 0, -height / 2 + 85);
    text("acercamiento a la programación para la creación de un sitio web y diversos diseños interactivos.", 0, -height / 2 + 105);
    textSize(12)
      text("(Mueve el cursor sobre el círculo y haz clic para visualizar las tareas. Para volver al inicio, haz doble clic en éste.)", 0, 150);
  } else {
    fill(300);
    if (clicHecho) {
      textSize(25);
